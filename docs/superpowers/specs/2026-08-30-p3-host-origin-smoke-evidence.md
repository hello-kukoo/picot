...
test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 369 filtered out; finished in 4.47s

    Finished `test` profile [unoptimized + debuginfo] target(s) in 0.28s
     Running unittests src/main.rs (target/debug/deps/picot-0c93d509a06003a5)
```
